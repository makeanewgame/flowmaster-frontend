...
import { useRegisterMutation } from "@/redux/service/authServiceApi";
    ...
    >
      ...
      <div className="container h-screen mx-auto flex justify-end items-center">
        <div className="bg-white p-8 rounded-lg shadow-2xl gap-4 flex flex-col">
          <Logo />
          <h1 className="text-2xl font-bold">Ücretsiz bir hesap oluşturun</h1>
          <p className="text-sm text-default-400">
            15 gün boyunca chatbu'yu ücretsiz dene!
          </p>
          ...
          <FormikProvider value={formik}>
            ...
            >
              ...
              <PhoneInputComponent
                ...
                onChange={(item: any) =>
                  formik.setFieldValue("phonenumber", item)
                }
              ...
              <div className="text-center">
                <Link>Kullanım Şartlarımızı</Link> ve{" "}
                <Link>Gizlilik Politikamızı</Link> kabul ediyorsunuz
              </div>
            </Form>
          </FormikProvider>
        </div>
