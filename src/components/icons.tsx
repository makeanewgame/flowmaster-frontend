...
export const EnterIcon = (props: any) => {
  return (
    ...
    >
      <path
        d="M19.9999 4V13C19.9999 14.0609 19.5785 15.0783 18.8284 15.8284C18.0782 16.5786 17.0608 17 15.9999 17H6.91394L9.41394 19.5L7.99994 20.914L3.08594 16L7.99994 11.086L9.41394 12.5L6.91394 15H15.9999C16.5304 15 17.0391 14.7893 17.4142 14.4142C17.7892 14.0391 17.9999 13.5304 17.9999 13V4H19.9999Z"
        fill="#71717A"
      />
    </svg>
  );
